              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select name="reservation_BOOKING_FOR" class="form-control" placeholder="BOOKING_FOR" required="">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select name="reservation_NUMBER_OF_PEOPLE" class="form-control" placeholder="NUMBER_OF_PEOPLE" required="">
