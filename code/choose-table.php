                ...
                <div class="container">
                    <div class="row slider-text align-items-center justify-content-center">
                        <div class="col-md-10 col-sm-12 ftco-animate text-center" style="padding-bottom: 25%;">
                            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Tables</span>
                            </p>
                                ...
                                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3" style="min-height: 190px">
                                            <p style="font-weight: bold; padding: "> TABLE <?php echo @$i += 1 ?>
                                            </p>
                                            <nav class="menu2">
                                                <input type="checkbox"
                                                    id="restTable<?php echo $table_id; ?>"
                                                    name="table[]" value="<?php echo $table_id; ?>"
                                                    class="menu-toggler2 restTable" data-id="<?php echo $table_id; ?>">
                                        ...
                                        <div class="col-lg-12" style="margin-top: 15%;text-align: center;">
                                            <div class="form-group">
                                                ...
                                                <p style="display:none;text-align: center;" id="viewMenu">
                                                    <input type="submit" value="Confirm" name="selectChair"
